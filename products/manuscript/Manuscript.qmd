...
These results highlight the potential of advanced machine learning algorithms, particularly Random Forest, in enhancing TB diagnosis and early detection strategies, offering valuable insights for clinical decision-making and the development of more effective screening protocols.
{{< pagebreak >}}
...
```{r }
#| label: tbl-model_perfomance_train
...
```{r }
#| label: fig-Random Forest_Roccurve
#| fig-cap: "Random Forest_Roccurve"
#| echo: FALSE
knitr::include_graphics(here("results","figures", "rf_ROCCURVE.png"))
```

```{r }
#| label: tbl-Support Vector Machine
...
```{r }
#| label: fig-supporter Vector Machine_Roccurve
...
```{r}
#| label: model_perfomance_test
#| tbl-cap: "model_perfomance_test"
#| echo: FALSE
