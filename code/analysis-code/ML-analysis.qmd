...
data_location <- here::here("data","processed-data","data2.rds")
#load data
...
# Tune Model (trying a variety of values of mtry and trees)
...
# Create a flextable from the data frame
#rfconf_table <- flextable(conf_dfrf)
