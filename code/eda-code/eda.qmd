...
table1 <- 
  madaproject %>%
  tbl_summary(
    include = all_of(c("Gender", "Asthma", "Smoke", "Alcohol", "feverstatus", 
...
# Save table
saveRDS(table1, file = here::here("results", "tables", "table1.rds"))
